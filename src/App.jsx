...
function sectionBadge(icon, text, textColor = "text-white") {
  ...
  return (
    <div
      className={`inline-flex max-w-full items-center gap-3 rounded-full px-4 py-2.5 text-xs font-semibold ${textColor} sm:px-5 sm:py-3 sm:text-sm ${SMALL_GLASS}`}
    >
...
function LargeSectionBadge({ icon: Icon, text }) {
  return (
    <div
      className={`inline-flex max-w-full items-center gap-3 rounded-full px-5 py-3 text-base font-bold sm:px-8 sm:py-4 sm:text-xl lg:text-2xl ${SMALL_GLASS}`}
      style={{ color: ACCENT }}
    >
...
function HeroAudioPlayer({ isMobile }) {
  ...
  return (
    <div className={`mt-5 rounded-[1.35rem] border border-white/10 ${DARK_PANEL} p-3 sm:p-4`}>
      <audio
        ref={audioRef}
        preload="metadata"
      ...
      <div className={`mb-4 flex h-14 items-end gap-[2px] overflow-hidden rounded-2xl border border-white/10 ${DARK_PANEL_SOFT} px-2 py-3 sm:h-18`}>
    ...
    >
      <div className={`h-full rounded-[1.5rem] border border-white/10 ${CARD_GLASS} p-4`}>
        <div className={`flex items-center gap-3 rounded-2xl border border-white/10 ${HEADER_GLASS} backdrop-blur-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] px-4 py-3`}>
          <div className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl ${SMALL_GLASS}`}>
        ...
        <div className={`mt-4 rounded-2xl border border-white/10 ${DARK_PANEL} px-4 py-4 text-sm leading-7 text-white/78 sm:text-base sm:leading-8`}>
          {desc}
        </div>
      </div>
    </motion.div>
    ...
    >
      <div className={`h-full rounded-[1.5rem] border border-white/10 ${CARD_GLASS} p-4`}>
        <div className={`flex items-center gap-3 rounded-2xl border border-white/10 ${HEADER_GLASS} backdrop-blur-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] px-4 py-3`}>
          ...
          <div
            className={`rounded-2xl px-4 py-2 font-bold text-white ${HEADER_GLASS} ${
        ...
        <div
          className={`mt-4 rounded-2xl border border-white/10 ${DARK_PANEL} px-4 py-4 text-white/80 ${
            large
...
function ProtectedHlsVideoCard({
  ...
  return (
    ...
    >
      <div className={`relative overflow-hidden rounded-[1.4rem] border border-white/10 ${DARK_PANEL}`}>
        <video
          ref={videoRef}
          src={video}
        ...
        {!isPlaying && (
          <button
            type="button"
            onClick={togglePlay}
            className={`absolute inset-0 flex items-center justify-center ${DARK_PANEL_SOFT} transition hover:bg-[linear-gradient(135deg,rgba(11,18,32,0.36)_0%,rgba(22,33,62,0.24)_100%)]`}
            aria-label="Shid muuqaalka"
          >
            <span className={`flex h-16 w-16 items-center justify-center rounded-full border border-white/20 ${FRAME_GLASS_SOFT} backdrop-blur-md shadow-[0_0_22px_rgba(125,211,252,0.22)] sm:h-18 sm:w-18`}>
              <Play className="mr-1 h-7 w-7 text-white" />
            </span>
          </button>
        )}

        <div className={`pointer-events-none absolute left-3 top-3 rounded-full border border-white/10 ${DARK_PANEL} px-3 py-1 text-[11px] text-white/80 backdrop-blur-md`}>
          {isReady ? "Sawirku wuu muuqdaa ka hor shididda" : "Muuqaalka hordhaca ah waa la diyaarinayaa"}
        </div>
      </div>

      <div className={`mt-4 rounded-[1.3rem] border border-white/10 ${DARK_PANEL} p-3 sm:p-4`}>
        <div className="flex flex-wrap items-center gap-2">
          <button
            type="button"
            onClick={toggleMute}
          ...
          <header className="pt-4 sm:pt-6">
            ...
            >
              <div className="flex min-w-0 items-center gap-3 sm:gap-4">
                <div className={`flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-full border border-sky-100/20 ${FRAME_GLASS_SOFT} shadow-[0_0_18px_rgba(125,211,252,0.22)] sm:h-16 sm:w-16`}>
                  <img
                    src={sanaLogo}
              ...
              <button
                ...
                className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 ${CARD_GLASS} md:hidden`}
              >
                ...
                <div className="grid gap-2">
                  {navItems.map((item) => (
                    <a
                      ...
                      className={`rounded-2xl border border-white/10 ${CARD_GLASS} px-4 py-3 text-sm text-white/85 sm:text-base`}
                    >
                      {item.label}
                    </a>
                  ))}
          ...
          <section className="relative grid min-h-[auto] items-center gap-10 py-10 sm:gap-12 sm:py-14 lg:min-h-[84vh] lg:grid-cols-[1.05fr_0.95fr] lg:py-20">
            <div className="order-1 lg:order-1">
              <motion.div
                ...
                animate="show"
                variants={fadeUp}
                className={`mb-5 inline-flex items-center gap-2 rounded-full border border-sky-200/20 ${FRAME_GLASS_SOFT} px-4 py-2 text-xs backdrop-blur-md sm:text-sm`}
                style={{ color: ACCENT }}
              >
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className={`inline-flex items-center justify-center gap-3 rounded-2xl border border-white/15 ${FRAME_GLASS_SOFT} px-6 py-3.5 text-sm font-semibold text-white backdrop-blur-md transition hover:bg-white/15 sm:px-7 sm:py-4 sm:text-base`}
                >
              ...
              >
                {stats.map((item, i) => (
                  <motion.div
                    ...
                    className={`rounded-3xl p-3 text-center sm:p-4 ${SMALL_GLASS}`}
                  >
            ...
            >
              ...
              >
                <div className="rounded-[1.6rem] border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-4 sm:p-6">
                  ...
                  <div className={`mt-6 rounded-[1.4rem] border border-white/10 ${DARK_PANEL} p-4 sm:mt-8 sm:p-6`}>
              ...
              <div className="mx-auto mt-5 grid max-w-2xl gap-3 sm:mt-6 sm:flex sm:flex-wrap sm:items-center sm:justify-center sm:gap-4">
                {heroBadges.map((item) => {
                  ...
                  return (
                    <div
                      key={item.title}
                      className={`w-full rounded-[1.4rem] px-5 py-4 text-center sm:min-w-[220px] sm:w-auto sm:rounded-[1.6rem] ${SMALL_GLASS}`}
                    >
                      <div className="flex items-center justify-center gap-3">
                        <div className={`flex h-10 w-10 items-center justify-center rounded-2xl sm:h-11 sm:w-11 ${SMALL_GLASS}`}>
                          <Icon className="h-5 w-5" style={{ color: ACCENT }} />
                        </div>
            ...
            >
              ...
              <div className="relative z-10">
                <div className="grid gap-6 lg:grid-cols-2 lg:items-stretch lg:gap-8">
                  <div className={`rounded-[1.8rem] border border-white/10 ${DARK_PANEL} p-4 sm:p-6`}>
                    <div className={`h-full rounded-2xl border border-white/10 ${CARD_GLASS} p-4 sm:p-5`}>
                  ...
                  <div className={`rounded-[1.8rem] border border-white/10 ${DARK_PANEL} p-4 sm:p-6`}>
                    <div className={`flex h-full flex-col justify-center rounded-2xl border border-white/10 ${CARD_GLASS} p-4 sm:p-5`}>
          ...
          <section id="contact" className="py-8 lg:py-12">
            ...
            >
              <div className="text-center">
                <div
                  className={`inline-flex max-w-full items-center gap-3 rounded-full px-5 py-3 text-base font-semibold sm:px-7 sm:py-4 sm:text-lg ${SMALL_GLASS}`}
                  style={{ color: ACCENT }}
                >
              ...
              >
                <div className={`rounded-[2rem] border border-white/10 ${DARK_PANEL} p-4 sm:p-6`}>
                  <div className={`rounded-[1.5rem] border border-white/10 ${CARD_GLASS} p-4 sm:p-5`}>
                    <div className="mb-4 text-xl font-bold sm:text-2xl">Nala soo xiriir</div>
                    <div className="space-y-3 text-white/75">
                      <div className={`rounded-2xl ${CARD_GLASS} px-4 py-3 text-sm sm:text-base`}>
